					...
					<div class="informbox">
						<div class="inform">
							<form action="/member/login" name="loginFrm" method="post">
								<ul> 
									<li><input type="text" class="loginType" id="id" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='loginType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
									<li><input type="password" class="passType" id="pw" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='passType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
								</ul>
