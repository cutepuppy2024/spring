...
<section>
    ...
    <table>
      ...
      <tr>
        ...
        <a href="/board/view?bno=${map.prevDto.bno}&page=${page}">[게시글] ${map.prevDto.btitle}</td></a>
        </c:if>
        <c:if test="${map.prevDto.bno == null }">
        다음글이 없습니다.
        </c:if>
      ...
      <c:if test="${map.nextDto.bno != null }">
        ...
        <a href="/board/view?bno=${map.nextDto.bno}&page=${page}">[게시글] ${map.nextDto.btitle}</td></a>
        </c:if>
        <c:if test="${map.nextDto.bno == null }">
       이전글이 없습니다.
        </c:if>
    ...
    <a href="/board/list?page=${page}&category=${cateogory}&searchWord=${searchWord}"><div class="list">목록</div></a>
