...
//	BoardService boardService = new BoardServiceImpl();  //다형성
	...
	public ModelAndView list(@RequestParam(defaultValue = "1") int page, 
			String category, String searchWord) {  // 현재페이지
		...
		// 리스트 , 검색 포함
		Map<String,Object> map = boardService.selectList(page, category, searchWord); // service로 넘김
		
		ModelAndView mv = new ModelAndView();
		mv.addObject("map",map); // map을 풀지 않고 보냄
