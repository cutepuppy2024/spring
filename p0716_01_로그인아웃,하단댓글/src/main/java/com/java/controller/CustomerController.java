...
public class CustomerController {
	...
	@RequestMapping("/customer/notice") // notice 리스트
	...
	public ModelAndView notice_view(NoticeDto noticeDto) {
		...
		System.out.println("controller list : "+((ArrayList) map.get("list")).size());
		ModelAndView mv = new ModelAndView();
	...
	public CommentBDto commentBUpdate(CommentBDto commentBDto) {
		System.out.println("controller bno : "+commentBDto.getCno());
		System.out.println("controller ccontent : "+commentBDto.getCcontent());
		
		// bno, id, cpw, ccontent
		CommentBDto cBDto = noticeService.commentBUpdate(commentBDto);
